...
- `pnpm verify`: 2026-09-14 tarihinde yerelde başarılı
...
`codex/catalog-capacity-batch` dalında Creaqua'nın güncel resmî altı sayfalık ürün dizinindeki 70 ailenin tamamı katalog ve regresyon testleriyle kapsandı. OrionLED'in resmî mağaza API'sindeki güncel 27 akvaryum aydınlatma ailesinin tamamı aile ve seçilebilir varyasyon düzeyinde kataloglandı; marka 164 ayrı aydınlatma seçeneğine ulaştı. Kaynakta güç yayımlanmayan Plant A, Bluetooth RGB, Fire ve Ice seçeneklerine güç uydurulmadı. Shade Mirror D-115 mağaza seçeneği ile açıklamadaki D-120 satırı çeliştiği için uyumluluk ölçüsü kullanılmadı. Sıradaki iş, JBL'in güncel resmî akvaryum ürün ailelerini mevcut 23 ekipman kaydıyla karşılaştırıp gerçek model ve seçenek boşluklarını küçük paketler halinde kapatmaktır.

## 2026-09-14 OrionLED ilk güncel ürün paketi

- OrionLED'in resmî tatlı su ürün dizini karşılaştırılmaya başlandı. Grolux A serisinin sekiz, Grolux T8 serisinin beş, C Black/Grey serisinin yedi ve D-REEF serisinin üç gerçek ölçü seçeneği kataloglandı.
- D-RGBW Black serisindeki yedi mevcut modele aynı teknik tablodaki yedi Grey kasa seçeneği eklendi. Nano Arc, Nano M1-B, Nano C Reef ve Nano Grolux doğrudan resmî ürün sayfalarındaki güç, LED, lümen veya cam uyumluluğu verileriyle eklendi.
- Eski iki genel A serisi kaydı ve yinelenen D-60S kaydı, güncel resmî seri kayıtlarıyla değiştirildi. Marka toplamı 70 ayrı aydınlatma seçeneğine ulaştı.
- Tam `pnpm verify` başarılıdır: TypeScript, katalog akışı, 52 sağlık senaryosu, hesaplayıcılar, katalog denetimi ve 14 sayfalık üretim derlemesi geçti.
- GitHub/Vercel: bu paket henüz gönderilmedi ve yayımlanmadı.

## 2026-09-14 OrionLED ikinci güncel ürün paketi

- Nano M-1 Karışık Renkli, Nano M-2 ve Nano M-3 doğrudan resmî ürün sayfalarındaki 6 W/500 lm, 14 W/1200 lm ve 20 W/2200 lm teknik verileriyle eklendi.
- Fanus & Nano Gooseneck 5V ve Fanus Mini LED Siyah; resmî 7 W ve 2 W güçleri, besleme ve cam uyumluluğu ayrıntılarıyla eklendi.
- Plant A serisinin 20–150 cm arasındaki 14 gövde/akvaryum ölçüsü kataloglandı. Ürün sayfasında güç tablosu bulunmadığı için güç değeri tahmin edilmedi. SPOT 24V 12W ürününün 3000K, 4000K ve 6500K seçenekleri ayrı modeller halinde eklendi.
- OrionLED'in sayfalı HTML kategori görünümü bu kontrolde 26 sonuç gösterdi; daha sonraki resmî mağaza API denetimi gerçek sayının 27 olduğunu ve eksik NANO SPOT ailesini ortaya çıkardı. Bu ara paket marka toplamını 92 seçeneğe ulaştırdı.
- GitHub/Vercel: bu paket henüz gönderilmedi ve yayımlanmadı.

## 2026-09-14 OrionLED üçüncü güncel ürün paketi

- Kumandalı B serisinin sekiz ve C RGB-W serisinin yedi gerçek model seçeneği, doğrudan resmî tablolardaki güç, lümen ve akvaryum uzunluğu değerleriyle eklendi.
- Bluetooth RGB serisinin 20–150 arasındaki 14 ölçü seçeneği kataloglandı. Resmî sayfa güç yayımlamadığı için güç değeri tahmin edilmedi.
- Eski tekil Extreme B 80 kaydı tam B serisiyle yinelenmemesi için kaldırıldı. Marka toplamı 120 aydınlatma seçeneğine ulaştı.

## 2026-09-14 OrionLED güncel akvaryum kataloğu tamamlandı

- Aquaslim Grolux Fire ve Ice ailelerinin resmî mağaza API'sinde seçilebilen sekizer boyu, Royal Mavi ailesinin 11 boyu ve Shade Mirror ailesinin yedi boy/iki renk olmak üzere 14 seçeneği eklendi.
- Royal Mavi 35 ve 65 cm varyantları mağazada seçilebilir olsa da açıklama güç tablosunda yer almadığı için güçleri boş bırakıldı. Shade Mirror mağazadaki D-115 seçeneği ile açıklamadaki D-120 satırı çeliştiği için D-115'in akvaryum uzunluğu tahmin edilmedi ve çelişki kullanıcıya gösterilecek açıklamaya işlendi.
- Resmî mağaza API denetiminde HTML sayfalamasında görünmeyen NANO SPOT 5V 3W ailesi bulundu; 3000K, 4000K ve 6500K seçenekleri resmî 3 W, 300 lm, 15°–90° mercek ve 4–16 mm cam verileriyle eklendi.
- Güncel resmî akvaryum aydınlatma dizinindeki 27 ailenin tamamı 164 ayrı seçenekle katalog ve regresyon kapsamındadır.
- GitHub/Vercel: bu paket henüz gönderilmedi ve yayımlanmadı.

## Önceki canlı katalog durumu

`codex/catalog-capacity-batch` dalındaki katalog çalışması sürüyor. Jeneca 410 ekipmana ve kapasite gerektiren 186 kaydın 183'ünde doğrulanmış otomatik hesap verisine ulaştı (%98); sayı yayımlanmayan eski/özel modeller tahmin edilmeden açıklamalı biçimde hesap dışında tutuluyor. Canlı profilleri akvaryumun freshwater / saltwater / brackish türüyle eşleştiriliyor; seçici uyumsuz canlı ve boş ana kategori göstermiyor, sağlık analizi eski/uyumsuz kayıtlarda tehlike uyarısı veriyor. Cikletist'in cüce ciklet envanterindeki 26 başlığın tamamı doğrulanmış profile bağlıdır. Vatoz/kedi balığı envanterindeki 56 başlığın 47'si doğrulanmış profile bağlıdır; bilimsel kimliği güvenle belirlenemeyen dokuz satış adı aramada açıklamalı ve eklenemez biçimde gösteriliyor. Yılan/müren kategorisindeki sekiz doğrulanmış profile ek olarak kimliği veya bakım eşiği belirsiz dört satış adı da aynı güvenlik akışına alındı. Afrika Arowanası ve Çin Ejderi güvenilir kimlik ve bakım kaynaklarıyla Monster profillerine bağlandı; Monster grubu 31 doğrulanmış profile ulaştı ve canlı sitedeki 21 başlığın tamamı yeniden doğrulandı. Cikletist Canlı Doğuranlar kategorisindeki iki sayfa ve 26 satış başlığının tamamı regresyon kapsamındadır; 25 başlık güvenli profile bağlı, tür belirtmeyen `ALBİNO SKY BLUE` açıklamalı güvenlik kaydıdır. Cikletist Betta kategorisindeki yem dışındaki 14 canlı başlığı da tam regresyon kapsamındadır; 13 başlık kaynaklı profile bağlı, türü belirsiz `MEYAN KÖKÜ GURAMİ` açıklamalı güvenlik kaydıdır. Japon/Oranda kategorisindeki 18 satış kaydının tamamı Japon balığı veya koi profiline bağlıdır; Japon balığı ek birey hacmi artık adet üzerinden otomatik hesaplanır. Labirentli Balıklar kategorisindeki 15 başlığın 13'ü kaynaklı profile bağlıdır; yalnız genel `Gurami` ve `MEYAN KÖKÜ GURAMİ` açıklamalı güvenlik kayıtlarıdır. Tetra Türleri ana kategorisinin altı güncel sayfasındaki 129 satış satırının 100'ü kaynaklı profile bağlıdır; kimliği veya güvenli su türü belirlenemeyen 29 satır, 28 benzersiz açıklamalı güvenlik kaydıyla kapsanır. Havuz Balıkları kategorisindeki sekiz güncel satış başlığının beşi koi, üçü Japon balığı profiline bağlıdır; Tül Kuyruk/Longfin koi ayrı tür olarak çoğaltılmamıştır ve mağaza başlıklarındaki yinelenen boşluklar artık güvenli eşleşmeyi bozmaz. Cikletist Balık Çeşitleri ana kategorisinin 16 güncel sayfasındaki 384 satış satırının 315'i doğrulanmış profile, 66'sı açıklamalı güvenlik kaydına bağlandı; canlı olmayan üç satır canlı kataloğundan açıkça dışlandı. Çözülmemiş görünür kayıt sayısı 61'dir. Ekipmanda kalan 12 açıklamalı kapasite boşluğunun üçü çelişkili, dokuzu yayımlanmamış veridir ve tahmin edilmeden güvenlik hesabı dışında tutulur. Sıradaki iş, kalan açıklamalı canlı kayıtlarından bilimsel adı açıkça verilenleri güvenilir kimlik ve bakım kaynaklarıyla küçük gruplar halinde doğrulamaktır.
...
## 2026-09-11 Regent kaynak ayrımı

- Regent 6500, 7500, 8500 ve 9500 modellerinin 100, 150, 210 ve 240 L/saat debileri tüm seriyi model satırlarıyla yayımlayan teknik ürün tablosuna bağlandı; Türkiye yetkili satıcıdaki model sayfaları ayrıca çapraz kaynak olarak korundu.
- Türkiye ürün etiketi ile uluslararası tablo arasındaki 6500 için 2,4/2,5 W ve 8500 için 4/3,5 W farkları kullanıcıdan saklanmadı. Otomatik kapasite hesabında debi korunurken Türkiye ürün gücü kullanıldı.
- Uluslararası tablo 6500–8500 için düşük/yüksek kademe bildiriyor; Türkiye sayfaları ayarlanabilir akışı açıkça doğrulamadığından yerel varyantlarda akış ayarı varsayılmadı. 9500'ün 240 L/saat, 4 W ve ayarlanabilir akış bilgisi bağımsız ürün kaynağıyla da doğrulandı.
- Tam `pnpm verify` başarılıdır: TypeScript, yedi ekipman kategorili ve 615 bakım ürünlü katalog akışı, 52 sağlık senaryosu, beş kum türünü kapsayan hesaplayıcı regresyonu, katalog denetimi ve 14 sayfalık üretim derlemesi geçti. Değişiklik henüz GitHub/Vercel'e gönderilmedi.

## 2026-09-11 Aquael güncel portföy genişletmesi

- Aquael OXYBOOST PLUS ailesinin dört modeli güncel resmî teknik tabloyla yeniden doğrulandı. AP-100, APR-150, AP-200 ve APR-300 için 100–300 L/saat debi, 2,2–2,5 W güç, 100–300 litre hacim aralıkları ve yalnız APR varyantlarındaki akış ayarı otomatik değerlendirmeye işlendi.
- Resmî portföyde bulunup katalogda eksik olan sekiz Platinium Heater varyantı eklendi: 25, 50, 75, 100, 150, 200, 250 ve 300 W. Her model üreticinin yayımladığı 10–300 litre aralığıyla ısıtıcı uygunluk hesabına katılıyor.
- Güncel iç filtre dizinindeki Turbo Mini, SAS Filter 500, Unifilter UV-C 500/750/1000, Neo 300 ve Neo Bio 1000; dış filtre dizinindeki Multikani 1000 ile FZN Pro 400/700/1000/1500 eklendi. PAT Mini'nin eski 400 L/saat ve 4 W verisi üreticinin güncel 450 L/saat ve 4,5 W tablosuyla düzeltildi.
- Aquael 50 ekipmandan 177 ekipmana çıktı. Kapasite gerektiren 72 Aquael kaydının 72'si de doğrulanmış otomatik hesap verisine sahiptir (%100); 127 yeni ve beş düzeltilen model ayrı regresyon kontrollerine bağlandı.
- Tam `pnpm verify` başarılıdır: TypeScript, yedi ekipman kategorili ve 615 bakım ürünlü katalog akışı, 52 sağlık senaryosu, beş kum türünü kapsayan hesaplayıcı regresyonu, katalog denetimi ve 14 sayfalık üretim derlemesi geçti.
- Ultramax BT; 2200 L/saat, en çok 13,5 W ve 100–750 litre verileriyle eklendi. Hypermax Link ve Hypermax BT Thermo, 4500 L/saat filtre debisi ile 2×150 W entegre ısıtıcıyı birlikte taşıyor; sağlık analizi bu iki cihazı hem filtrasyon hem ısıtma uygunluğunda otomatik değerlendiriyor.
- Ultra Heater Day&Night ailesinin 25–200 W arasındaki altı güncel modeli resmî kapasite aralıklarıyla eklendi. Flow Heater BT'nin 50–500 W ayarlanabilir gücü ve 60 litre alt sınırı işlendi; aynı resmî sayfanın anlatımında 1000 L, teknik tablosunda 100 L yazdığı için çelişkili üst sınır otomatik uygunluk hesabına alınmadı.
- Güncel aydınlatma portföyünden dört Leddy Slim Sunny Day&Night, altı Leddy Tube Sunny Day&Night, üç Ultra Slim BT, dört Leddy Slim BT ve iki Leddy Smart Day&Night modeli eklendi. Akvaryum genişliği yalnız resmî tabloda doğrudan yayımlanan Slim ve Ultra Slim modellerine işlendi; modül boyu akvaryum önerisi gibi kullanılmadı.
- Leddy Tube Plant 2.0 ailesinin dört gücü, Leddy Tube Marine Day&Night ailesinin üç gücü, güncel 4,8 W Leddy Tube Sunny, iki Leddy Slim Duo Sunny Plant&Night ve 10 W Leddy Slim Duo Marine&Actinic eklendi. Tube modüllerinin fiziksel boyları akvaryum önerisi gibi kullanılmadı; yalnız Slim Duo için üreticinin doğrudan yayımladığı akvaryum genişliği işlendi.
- Leddy Slim Marine Day&Night 32/36 W, 10–50 litre Leddy Smart BT ve 1 W Moonlight LED eklendi. Airlights LED, kendi pompası bulunmayan aydınlatmalı hava taşı olduğu için ana aydınlatma/filtre kapasitesine karışmayan pasif aksesuar olarak sınıflandırıldı.
- Leddy Slim Link 36 W, resmî 100–120 cm, 2750 lm ve 1–36 W ayar bilgileriyle eklendi. Slim Hanger ile iki parçalı Glossy/Opti Set çerçeve braketi ana lamba kapasitesine karışmayan pasif montaj aksesuarları olarak ayrı tutuldu.
- Uni Pump 700/1000/1500 modelleri resmî 700/1000/1400 L/saat debi, 9,5/15/19 W güç ve basma yükseklikleriyle eklendi. Sirkülasyon pompaları gibi ana filtre kapasitesine karışmadan ayrı pompa ekipmanı olarak tutuluyor.
- Güncel sterilizatör portföyünün tamamı eklendi: 120 litreye kadar Sterilizer UV 3 W LED, 200–800 litre aralığını dört modele bölen Sterilizer UV AS 2.0 5/7/9/11 W ve 150 litreye kadar Mini UV C. UV gücü, toplam cihaz tüketimi ve filtre/pompa uyumluluğu kaynakta ayrıldığı ölçüde ayrı işlendi.
- Thermometer BT, Socket BT Duo, Wi-Fi Gateway BT, Thermometer Link ve Socket Link Duo resmî özellikleriyle eklendi; bu kontrol cihazları filtre, ısıtıcı veya UV kapasitesi gibi değerlendirilmeden diğer ekipman kategorisinde tutuluyor.
...
- Bu 230 Aquael ürünlü kontrol paketi tam `pnpm verify` sonrasında `5a94fcc` commit'iyle `codex/catalog-capacity-batch` görev dalına gönderildi. Vercel görev dalı önizlemesi başarıyla tamamlandı: `https://aqua-mind-git-codex-catalog-capacity-batch-ckaracoras-projects.vercel.app/`. `main` ve genel üretim yayını değiştirilmedi.
- Resmî dolap dizininde kalan UltraScape'in dört, Glossy ST Grey'in beş, Hexa'nın iki ve Fish & Shrimp Set Duo'nun iki varyantı ayrı kayıtlar olarak eklendi. Dolap portföyü 30 varyanta, Aquael toplamı 243 ürüne ve genel ürün kataloğu 858 kayda ulaştı.
- Bu 13 kayıtlık ek dolap paketi tam `pnpm verify` sonrasında `codex/catalog-capacity-batch` görev dalına gönderildi ve Vercel dal önizlemesi güncellendi: `https://aqua-mind-git-codex-catalog-capacity-batch-ckaracoras-projects.vercel.app/`. `main` ve genel üretim yayını değiştirilmedi. Sıradaki iş, resmî akvaryum seti dizinindeki kalan aileleri hacim, ölçü ve set içeriği seçenekleriyle küçük gruplar halinde doğrulamaktır.
- Shrimp Set Day&Night'ın altı, Fish & Shrimp Set Duo'nun iki, Opti Set 130'un üç ve Leddy XL Day&Night'ın iki varyantı resmî hacim, ölçü ve kutu içeriğiyle eklendi. Akvaryum seti sayısı 29'a, Aquael ürün sayısı 256'ya ve genel ürün kataloğu 871 kayda ulaştı.
- Bu 13 setlik yerel paket henüz GitHub/Vercel'e gönderilmedi. Sıradaki iş, açık teknik tablo yayımlayan kalan resmî Aquael set ailelerini küçük gruplar halinde doğrulamaktır.
- UltraScape'in dört, OptiBent'in altı, klasik Opti Set'in dokuz, Hexa Set'in bir ve NanoReef Duo'nun bir varyantı resmî hacim, ölçü ve yayımlanan kutu içeriğiyle eklendi. Akvaryum seti sayısı 50'ye, Aquael ürün sayısı 277'ye ve genel ürün kataloğu 892 kayda ulaştı.
- Bu 21 setlik ikinci yerel paket de henüz GitHub/Vercel'e gönderilmedi. 892 ürünlük güncel yerel durum için tam `pnpm verify` başarılıdır: TypeScript, katalog akışı, 52 sağlık senaryosu, hacim/su değişimi/beş kum türü hesaplayıcıları, katalog denetimi ve 14 sayfalık üretim derlemesi geçti. Sıradaki iş, Glossy ST, Leddy Day&Night, Leddy Plus ve kalan küçük set ailelerinin açık teknik tablolarını karşılaştırmaktır.
- Leddy Day&Night'ın altı, Leddy Plus'ın altı, Leddy Mini Creative'in dört ve Glossy ST Grey'in beş varyantı resmî hacim, ölçü ve yayımlanan ekipman bilgileriyle eklendi. Akvaryum seti sayısı 71'e, Aquael ürün sayısı 298'e ve genel ürün kataloğu 913 kayda ulaştı.
- Bu 21 setlik üçüncü yerel paket henüz GitHub/Vercel'e gönderilmedi. Sıradaki iş, Betta Kit, Aquaterrarium, Glossy Marine ve resmî set dizininde kalan güncel ailelerin gerçek varyant tablolarını karşılaştırmaktır.
- Betta Kit, Glossy Marine Standard, Glossy Marine Optimum ve ayrı Glossy Marine dolabı resmî hacim/ölçü/ekipman bilgileriyle eklendi. Akvaryum seti sayısı 74'e, dolap sayısı 31'e, Aquael ürün sayısı 302'ye ve genel ürün kataloğu 917 kayda ulaştı.
- Aquael'in resmî Aquaterrarium broşüründe 60/80/100 cm modellerinin 60 × 30 × 20,5; 80 × 35 × 30,5 ve 100 × 40 × 35,5 cm ölçüleri doğrulandı. Yalnız 80 ve 100 modellerinde yayımlanan 500 L/saat filtre bilgisi işlendi; 60 modeline filtre atanmadı. Üç model yeni `Aquaterrarium` kategorisine eklendi.
- Selva Mini, resmî 20 × 20 × 30 cm Opti cam gövdesi, Bluetooth WRGB LED'i ve havalandırma sistemiyle ayrı `Terrarium` kategorisine eklendi. Böylece Aquael 306 ürüne, genel ürün kataloğu 921 kayda ulaştı; bu yerel paket henüz GitHub/Vercel'e gönderilmedi.
- Aquael'in güncel resmî akvaryum seti dizinindeki 20 ailenin tamamı katalogda doğru ürün kategorisi ve doğrudan üretici kaynağıyla temsil ediliyor. Bu aile kapsamı ayrı regresyon testiyle korunuyor; sıradaki iş Aquael'in ürün dizininde setler dışında kalan kategori ailelerini mevcut katalogla karşılaştırarak gerçek boşlukları çıkarmaktır.
- Aquael'in güncel `Aquariums` dizinindeki üç Opti Tank, altı siyah/beyaz Opti Tank Rounded ve dört Glass Bowl varyantı eklendi. Fanuslarda kaynak ölçü yayımlamadığı için yalnız 4,5/8,5/13/45 L hacimler işlendi; eski Opti Tank Scape/Diamond belgelerindeki 90 cm hacim çelişkisi kataloğa taşınmadı. Boş tank kategorisi 27 varyanta, Aquael 319 ürüne ve genel ürün kataloğu 934 kayda ulaştı.
- Aquael'in güncel tam ürün dizinindeki üç somut boşluk kapatıldı: OXYPRO 150 resmî 150 L/saat, 2 W, 200 litre üst sınırı ve ayarlanabilir akış bilgisiyle; Neo Bio 1000 Additional Module ise bağımsız debi atanmayan pasif filtre modülü olarak eklendi. Opti Set Cabinet 130'un beyaz, siyah ve gri varyantları ayrı ürünlerdir; resmî sayfa 60 cm genişlik, 80 cm yükseklik ve 200 kg taşıma kapasitesi yayımladığı halde derinlik vermediği için tam üç boyutlu ölçü tahmin edilmedi. Aquael 179 ekipman ve 322 ürüne, dolap kategorisi 34 varyanta ve genel ürün kataloğu 937 kayda ulaştı.
- Leddy Slim BT'nin dört boyundaki siyah ve beyaz seçenekler sekiz ayrı ürün koduna; Leddy Slim Sunny Day&Night ve Leddy Slim Plant ailelerinin resmî tabloda gerçekten yayımlanan renk seçenekleri de ayrı seçilebilir kayıtlara dönüştürüldü. Mevcut kimlikler geriye dönük seçimleri koruyacak biçimde siyah veya tek yayımlanan beyaz seçeneğe bağlandı; sekiz yeni renk varyantıyla Aquael ekipman kataloğu 187 kayda ulaştı.
- Leddy Slim Marine Day&Night 32/36 W, Leddy Slim Duo Sunny Plant&Night 10/16 W ve Leddy Smart Day&Night Sunny/Plant modellerinin resmî siyah-beyaz ürün kodları da ayrı kayıtlara dönüştürüldü. Altı yeni renk varyantıyla Aquael ekipman kataloğu 193 kayda ulaştı; güç, lümen, renk sıcaklığı ve uzunluk değerleri yalnız üretici tablosundan alındı.
- Leddy Smart BT'nin beyaz ve siyah resmî SKU'ları da ayrı seçilebilir kayıtlara ayrıldı. Aquael'in güncel resmî Aquaristics dizinindeki 154 ürün ailesi katalog karşılaştırmasından geçirildi; ana aile boşluğu kalmadı. Katalog 194 Aquael ekipmanı, 322 Aquael yapısal/bakım ürünü ve toplam 937 bakım/ürün kaydı içeriyor. Tam `pnpm verify` başarılıdır: TypeScript, katalog akışı, 52 sağlık senaryosu, hacim/su değişimi/beş kum türü hesaplayıcıları, katalog denetimi ve 14 sayfalık üretim derlemesi geçti.
- Chihiros'un resmî mağazasında ayrı seçenek olarak yayımlanan A II Max 301/451/601/801/901/1201 modelleri eklendi. Ürün sayfası model bazında güç veya lümen tablosu vermediği için bu değerler tahmin edilmedi.
- White LED Background'un 30x30, 35x30, 45x30, 50x35, 60x36, 60x45 ve 90x45 cm seçenekleri resmî 4,7–19,6 W güç değerleriyle eklendi. Arka plan aydınlatmaları filtre veya ısıtıcı kapasitesine karışmadan aydınlatma kategorisinde tutuluyor. Chihiros toplamı 61 ekipmana ulaştı; bu yerel paket henüz GitHub/Vercel'e gönderilmedi.
- Chihiros'un resmî ürün duyurusundaki iki Metal Inflow Outflow Pro, dört Metal Inflow Outflow Set ve 12/16–16/22 mm hortumlara ait sekiz Lily/Poppy/U/Spiral cam boru seçeneği ayrı kayıtlara dönüştürüldü. Bu 14 parça bağımsız pompa veya debi içermeyen pasif aksesuar olarak tutuldu. Chihiros toplamı 75 ekipmana ulaştı; bu yerel paket henüz GitHub/Vercel'e gönderilmedi.
- Chihiros'un resmî canlı mağaza verisindeki 20 güncel montaj/yedek aksesuarı eklendi: Doctor Mate reaktörü; altı B Series gölgelik boyu; C II/C II RGB standları; WRGB, Slim, Pro ve A II Max askı/stand seçenekleri; VIVID siyah-gümüş gölgelikleri ve Wabi Kusa askısı. Ülkeye göre değişen priz seçenekleri ayrı cihaz gibi çoğaltılmadı. Bu kayıtlar ana cihaz gücü veya kapasitesine karışmayan pasif aksesuar olarak sınıflandırıldı; Chihiros toplamı 95 ekipmana ulaştı.
- Resmî LED Beads Panel sayfasındaki 34 uyumluluk seçeneği ayrı yedek parça olarak eklendi. WRGB II, 10th Edition, Slim, Pro, RGB VIVID ve A II ailelerinin güncel/eski uyumlu modelleri korunurken bu parçalar ana lamba gibi güç veya akvaryum uzunluğu hesabına sokulmadı. Chihiros toplamı 129 ekipmana ulaştı; yerel paket henüz GitHub/Vercel'e gönderilmedi.
- Chihiros Power Supply Replacement ürünündeki 12 farklı voltaj/akım konfigürasyonu Standard ve Waterproof gövde seçenekleriyle 24 kayıt olarak eklendi. EU/UK/US/AU prizleri aynı elektriksel cihazın bölgesel seçeneği olduğu için ayrı katalog cihazları olarak çoğaltılmadı. Yedek güç kaynakları ana ekipman tüketimine karışmayan pasif parçalar olarak tutuldu.
- Resmî LED panel uyumluluk listesinde bulunan ancak aydınlatma kataloğunda eksik olan A II 351/361/451/501/1201 ve B 60 eklendi. Üretimden kaldırıldığı açıkça belirtilen A II 351/361/451 etiketlendi; model bazında güç tablosu yayımlanmadığı için güç değeri uydurulmadı. Chihiros toplamı 159 ekipmana ulaştı; yerel paket henüz GitHub/Vercel'e gönderilmedi.
- Resmî arşivdeki C201, C251, C301 ve C361 nano lambalar doğrudan yayımlanan 7/10/14/18 W ve 750/1150/1500/1850 lm değerleriyle eklendi. Nova 1, üreticinin resmî yazısındaki 126 W, 3800 lm, 61 LED ve 45–60 cm akvaryum verileriyle deniz aydınlatması olarak eklendi. Chihiros toplamı 164 ekipmana ulaştı; yerel paket henüz GitHub/Vercel'e gönderilmedi.
- Resmî arşivdeki 13 bakım aracı, Commander 1, Manual Dimmer, Wi-Fi Hub, CO₂ solenoid kontrolcüsü ve üç Doctor 4th Gen varyantı eklendi. Bakım araçları ve kontrol modülleri pasif tutuldu; Doctor cihazları filtre veya UV kapasitesi gibi değerlendirilmedi. Chihiros toplamı 184 ekipmana ulaştı; bu kayıtları da kapsayan güncel yerel Chihiros paketi henüz GitHub/Vercel'e gönderilmedi.
- Chihiros'un resmî destek ve arşiv sayfalarındaki CO₂ ürünleri seçenek düzeyinde genişletildi: Pro Limited, Mate ve Pro regülatör aileleri; W21.8/G5/8/CGA320 bağlantılı eski regülatörlerin solenoidli-solenoidsiz seçenekleri; Mini kitin beş satış seçeneği; 2,5 L jeneratör ve M/L/XL dış difüzörlerle Diffuser Mate. Pasif manifold, kartuş ve difüzörler bağımsız kapasite cihazı gibi değerlendirilmedi; kaynakta yayımlanmayan akvaryum kapasitesi tahmin edilmedi. Chihiros toplamı 206 ekipmana ulaştı; bu CO₂ paketi henüz GitHub/Vercel'e gönderilmedi.
- Chihiros Magnetic Light ile 15 ml ve 35 ml hazneli Fish Feeder modelleri resmî ürün/destek sayfalarıyla eklendi. Glass Air akvaryum, iki Magnetic Light terrarium seti, Tiny Terrarium Egg ve Aqua Soil doğru yapısal/ürün kategorilerine ayrıldı; arşivde yayımlanmayan ölçü veya paket hacmi tahmin edilmedi. Chihiros toplamı 209 ekipmana, genel bakım/ürün kataloğu 942 kayda ulaştı; bu yerel paket henüz GitHub/Vercel'e gönderilmedi.
- Chihiros'un üç gerçek Clean Hose çap seçeneği, 5–18 mm camla uyumlu ikili Small Hanging Stand ve dört arşiv yedek parçası (Nova 1 PCB, WRGB I kablosu, Doctor güç kaynağı, dozaj pompası bağlantı hortumu) eklendi. Sekiz kayıt da ana cihaz kapasitesine karışmayan pasif parça olarak sınıflandırıldı. Chihiros toplamı 217 ekipmana ulaştı; bu yerel paket henüz GitHub/Vercel'e gönderilmedi.
- Chihiros arşivindeki Magnetic Light Base/S/L, iki U klips, VIVID 2 Mini soğutma fanı, Magnetic Light 2 ve ECO Ping'in entegre ışığı eklendi; Magnet Cleaner Mini/Nano iki gerçek seçenek olarak ayrıldı. 6,1 L ECO Ping, dairesel gövdesi uydurma dikdörtgen ölçülere çevrilmeden ayrı akvaryum seti kaydı oldu. Chihiros toplamı 226 ekipmana, genel bakım/ürün kataloğu 943 kayda ulaştı; paket henüz GitHub/Vercel'e gönderilmedi.
- Chihiros'un resmî HTML ürün arşivi yeniden tarandı; mevcut yeni aksesuarlarla aynı ürünü temsil eden sayfalar çoğaltılmadan VIVID/WRGB/A II ailelerine ait 21 gerçek eski LED paneli, PCB, Bluetooth ve montaj parçası eklendi. Akvaryum ürünü olmayan tişört ve hatıra kupası dışlandı; Glass Pot for Plant ölçü uydurulmadan terrarium ürünlerine eklendi. Chihiros toplamı 247 ekipmana ve yedi yapısal/bakım ürününe, genel bakım/ürün kataloğu 944 kayda ulaştı. Paket henüz GitHub/Vercel'e gönderilmedi.
- Güncel mağaza sayfalarında HTML arşiv listesine girmeyen Z Light Tiny Standard ve Diving sürümleri resmî 6 W, 400 lm, 2800–8000 K ve 15–60° verileriyle; 6 cm uzatma kolu ve 12–20 mm L klips ayrı seçenekleriyle eklendi. RGB VIVID II Mini'nin 75 W/5000 lm teknik verisi tamamlandı, Mount ve Pendant gölgelikleri ayrıldı ve Dosing Tube Holder X eklendi. Chihiros toplamı 253 ekipmana ulaştı; bu yerel paket henüz GitHub/Vercel'e gönderilmedi.
- Chihiros Cooling Fan'ın Manual/Bluetooth sürümleri; WiFi Hub Pro'nun cihaz, iki stand ve iki paket seçeneği; üç Filter Hose Pro çapı; 12/16 mm Double Tap; üç gerçek Pro-Brush seçeneği; Magnetic Stirrers ve Smart Power Strip doğrudan üretici mağazası/destek kaynaklarıyla eklendi. Filter Hose Pro sayfasının ürün seçicisi ile teknik tablosu çeliştiği için 9/12 ve 19/25 seçeneklerine yayımlanmayan iç/dış çap ayrıntıları türetilmedi. Smart Power Strip'in 3000 W azami anahtarlama yükü cihaz tüketimi olarak işlenmedi. Chihiros toplamı 269 ekipmana ulaştı; bu yerel paket henüz GitHub/Vercel'e gönderilmedi.
- Chihiros resmî destek duyurularındaki Doctor 5, iki Dosing Flow Adapter çapı, Sand Flattener, S/L Extendable 3D Net, çift taraflı temizlik bezi, ayarlanabilir A II standı ve yeni Pro/Max makas-cımbız seçenekleri eklendi. Doctor 5 için resmî kaynakta yayımlanmayan hacim kapasitesi tahmin edilmedi; pasif bakım ve bağlantı ürünleri cihaz kapasitesine karıştırılmadı. Glass Pot Dew'in üç tipi ve kişiye özel Acrylic UV Print POD doğru yapısal/dekorasyon kategorilerine eklendi. Chihiros toplamı 289 ekipmana, genel bakım/ürün kataloğu 948 kayda ulaştı; paket henüz GitHub/Vercel'e gönderilmedi.
- Creaqua'nın resmî güncel ürün sayfalarından ilk iki seçenek paketi eklendi: Crystal 45 ve Crystal Classic'in 12'şer akvaryum ölçüsü; Stand 45'in 10, Desktop Nano Stand'ın dört mobilya ölçüsü; üç AquaMat; dört Bitkili ve beş Reptile Teraryum; iki Askı Profili, üç Chrome Pipe, Pipe Holder, Compact RO ve Express ön filtre; üç REVEX ambalajı, Clarifier Filter Pad ve Media Bag. Akvaryumların brüt geometrik hacimleri ölçülerden hesaplandı; renkler aynı teknik ürünün seçenekleri olduğundan gereksiz kopyalanmadı. Compact ve Express günlük su hazırlama cihazları akvaryum filtre debisi/hacmi gibi değerlendirilmedi. Creaqua toplamı 43 ekipman ve 77 ürüne, genel bakım/ürün kataloğu 1003 kayda ulaştı. Paket yerelde tam doğrulamadan geçirilecek; henüz GitHub/Vercel'e gönderilmedi.
- Creaqua'nın resmî güncel ağaç ve kaya portföyü doğrudan ürün sayfalarıyla tamamlandı: altı tekil ağaç ailesi, üç Twigy ve iki Twigy Large seçeneği ile altı kaya/dekor ailesi eklendi. Alder Cones, Kurrajong Pods ve Banana Leaves doğal su düzenleyici; Plantie'nin iki rengi bitki sabitleme ürünü; Just Clear yayımlanan 2,5 ml/50 L dozu ve 5000 L şişe karşılığıyla, Eraser Brick ise 10 × 7 × 1 cm pasif bakım aracı olarak eklendi. Creaqua toplamı 44 ekipman ve 100 ürüne, genel bakım/ürün kataloğu 1026 kayda ulaştı. Yeni ürünlere yayımlanmayan paket ağırlığı veya kapasite atanmadı; paket henüz GitHub/Vercel'e gönderilmedi.
- Creaqua'nın resmî 70 ürün ailesi, altı sayfalık güncel ürün dizinine karşı ayrı regresyon listesiyle bağlandı. Eksik Brown kozmetik kum, üretici paket hacmi yayımlamadığı için miktar uydurulmadan eklendi. CO₂ hortumu eski üç genel renkten üreticinin güncel Şeffaf, Siyah, Metalik Gri ve Cam Mavisi seçeneklerine çıkarıldı; önceki mavi kaydın kimliği geriye dönük uyumluluk için Cam Mavisi seçeneğinde korundu. Creaqua toplamı 45 ekipman ve 101 ürüne, genel bakım/ürün kataloğu 1027 kayda ulaştı. Tam `pnpm verify` başarılıdır: TypeScript, 70 ailelik Creaqua kapsamı, katalog akışı, 52 sağlık senaryosu, hesaplayıcılar, katalog denetimi ve 14 sayfalık üretim derlemesi geçti. GitHub/Vercel henüz güncellenmedi.
- Arayüzdeki örnek profil adı ana sayfa, masaüstü menüsü, mobil menü ve ayarlarda `Canberk` olarak güncellendi; avatar baş harfi `C` oldu. Değişikliği de kapsayan tam `pnpm verify` 2026-09-14 tarihinde başarıyla geçti.
