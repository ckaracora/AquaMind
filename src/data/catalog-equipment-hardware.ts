...
const jenecaXpVerified:Record<string,Partial<EquipmentProfile>>={
  ...
  "XP-605":{specifications:"Yüzey emişli ince gövdeli askı filtre · 250 L/saat · 3,5 W",ratedFlowLph:250,powerW:3.5,adjustableFlow:true,sourceUrl:"https://gb.aleas.cn/product/684.html",verifiedAt:"2026-09-04"},
  ...
  // Üreticinin model tablosu her varyantı ayrı satırda yayımlar. Eski ikincil
  // kaynakla çelişen GD-403 ve GD-503 sayıları kesin değer olarak kullanılmaz.
  "GD-402":{specifications:"İki katmanlı ayarlanabilir damlama üst filtresi · 500 L/saat · 8 W",ratedFlowLph:500,powerW:8,adjustableFlow:true,sourceUrl:"https://gb.aleas.cn/product/630.html",verifiedAt:"2026-09-04"},
  "GD-403":{specifications:"Üç katmanlı ayarlanabilir damlama üst filtresi · teknik kaynaklar çelişkili",adjustableFlow:true,capacityDataNote:"Jeneca/ALEAS üretici tablosu ve bağımsız model sayfası 500 L/saat ve 8 W; başka güncel satıcılar 800 L/saat ve 10 W yayımlıyor. Etiket veya sürüm ayrımı doğrulanamadı. Çelişki çözülene kadar otomatik filtrasyon hesabına katılmaz.",sourceUrl:"https://gb.aleas.cn/product/630.html",additionalSourceUrls:["https://seasunaquarium.com/shop/index.php?flypage=flypage.tpl&option=com_virtuemart&page=shop.product_details&product_id=1679&vmcchk=1","https://yellowtail.shop/product/jeneca-gd-403-aquarium-top-filter-2-feet-tank/"],verifiedAt:"2026-09-08"},
  "GD-502":{specifications:"İki katmanlı ayarlanabilir damlama üst filtresi · 1000 L/saat · 15 W",ratedFlowLph:1000,powerW:15,adjustableFlow:true,sourceUrl:"https://gb.aleas.cn/product/630.html",verifiedAt:"2026-09-04"},
  "GD-503":{specifications:"Üç katmanlı ayarlanabilir damlama üst filtresi · teknik kaynaklar çelişkili",adjustableFlow:true,capacityDataNote:"Jeneca/ALEAS üretici tablosu ve bağımsız model sayfası 1000 L/saat ve 15 W; başka güncel satıcılar 1500 L/saat ve 20 W yayımlıyor. Etiket veya sürüm ayrımı doğrulanamadı. Çelişki çözülene kadar otomatik filtrasyon hesabına katılmaz.",sourceUrl:"https://gb.aleas.cn/product/630.html",additionalSourceUrls:["https://seasunaquarium.com/shop/index.php?Itemid=4&flypage=flypage.tpl&option=com_virtuemart&page=shop.product_details&pop=0&product_id=1678","https://greenfinaqua.com/products/jeneca-aquarium-top-filters-gd-series"],verifiedAt:"2026-09-08"},
  "GD-602":{specifications:"İki katmanlı ayarlanabilir damlama üst filtresi · 1800 L/saat · 25 W",ratedFlowLph:1800,powerW:25,adjustableFlow:true,sourceUrl:"https://gb.aleas.cn/product/630.html",verifiedAt:"2026-09-04"},
  "GD-603":{specifications:"Üç katmanlı ayarlanabilir damlama üst filtresi · 1800 L/saat · 25 W",ratedFlowLph:1800,powerW:25,adjustableFlow:true,sourceUrl:"https://gb.aleas.cn/product/630.html",additionalSourceUrls:["https://seasunaquarium.com/shop/index.php?category_id=96&flypage=flypage.tpl&option=com_virtuemart&page=shop.product_details&product_id=1685&vmcchk=1"],verifiedAt:"2026-09-04"},
};
for(const item of jenecaCurrentFilters){Object.assign(item,jenecaXpVerified[item.model]??{});}
for(const item of jenecaCurrentFilters.filter(item=>["TGD-15","TGD-16","TGD-17","TGD-18","TGD-19"].includes(item.model))){
  item.specifications=`${item.specifications} · 400 L/saat · 6 W · yükseltilebilir damlama kutusu`;
  item.ratedFlowLph=400;
  item.powerW=6;
  item.sourceUrl="https://www.aleas.cn/product/712.html";
  item.verifiedAt="2026-09-04";
}
...
const jenecaAirVerified:Record<string,Partial<EquipmentProfile>>={
  ...
  "DC-001":{specifications:"Şarjlı tek çıkışlı DC hava motoru · 1,3 L/dakika (78 L/saat) · 0,018 MPa · DC 3,7 V",ratedFlowLph:78,sourceUrl:"https://gb.aleas.cn/product/648.html",verifiedAt:"2026-09-04"},
  "DC-003":{specifications:"Şarjlı çift çıkışlı DC hava motoru · 2 × 1,5 L/dakika (180 L/saat toplam) · 0,018 MPa · sürekli ve 10 saniyelik aralıklı çalışma",ratedFlowLph:180,sourceUrl:"https://www.aleas.cn/product/702.html",verifiedAt:"2026-09-04"},
};
...
const jenecaOfficialExpandedFilters:EquipmentProfile[]=[
  ...
  {id:"jeneca-xp-18",category:"filter",brand:"Jeneca",model:"XP-18",specifications:"Yüzey emişli ayarlanabilir askı filtre · 240 L/saat · 4,2 W · 48 litreye kadar",ratedFlowLph:240,powerW:4.2,recommendedMaxL:48,adjustableFlow:true,sourceUrl:"https://www.aleas.cn/product/474.html",additionalSourceUrls:["https://www.thisshop.com/item/detail?itemId=4001820291704"],verifiedAt:"2026-09-04"},
  {id:"jeneca-xp-19",category:"filter",brand:"Jeneca",model:"XP-19",specifications:"Yüzey emişli ayarlanabilir askı filtre · 270 L/saat · 4,8 W · 54 litreye kadar",ratedFlowLph:270,powerW:4.8,recommendedMaxL:54,adjustableFlow:true,sourceUrl:"https://www.aleas.cn/product/474.html",additionalSourceUrls:["https://www.thisshop.com/item/detail?itemId=4001820291704"],verifiedAt:"2026-09-04"},
  {id:"jeneca-xp-31",category:"filter",brand:"Jeneca",model:"XP-31",specifications:"Yüzey emişli ayarlanabilir askı filtre · 240 L/saat · 4,2 W",ratedFlowLph:240,powerW:4.2,adjustableFlow:true,sourceUrl:"https://www.aleas.cn/product/474.html",verifiedAt:"2026-09-04"},
  {id:"jeneca-xp-32",category:"filter",brand:"Jeneca",model:"XP-32",specifications:"Yüzey emişli ayarlanabilir askı filtre · 270 L/saat · 4,8 W",ratedFlowLph:270,powerW:4.8,adjustableFlow:true,sourceUrl:"https://www.aleas.cn/product/474.html",verifiedAt:"2026-09-04"},
  {id:"jeneca-ae-1000",category:"filter",brand:"Jeneca",model:"AE-1000",specifications:"Kendinden emişli ayarlanabilir dış filtre · 850 L/saat · 9,3 W · 170 litreye kadar",ratedFlowLph:850,powerW:9.3,recommendedMaxL:170,adjustableFlow:true,sourceUrl:"https://thuysinhvanxuan.com/loc-thung-jeneca-loc-chuyen-dung-cho-ho-ca-thuy-sinh-ae1000-ae1300-ae1500-ae1800",additionalSourceUrls:["https://enaoniromiaefxi.com/products/castle-dawn-aquatics-auto-prime-external-perfomance-canister/234720193/"],verifiedAt:"2026-08-30"},
  {id:"jeneca-ae-1300",category:"filter",brand:"Jeneca",model:"AE-1300",specifications:"Kendinden emişli ayarlanabilir dış filtre · 950 L/saat · güç ve önerilen hacim farklı satış kaynaklarında çelişkili",ratedFlowLph:950,adjustableFlow:true,sourceUrl:"https://thuysinhvanxuan.com/loc-thung-jeneca-loc-chuyen-dung-cho-ho-ca-thuy-sinh-ae1000-ae1300-ae1500-ae1800",additionalSourceUrls:["https://enaoniromiaefxi.com/products/castle-dawn-aquatics-auto-prime-external-perfomance-canister/234720193/"],verifiedAt:"2026-08-30"},
  ...
  ] as const).map(([model,ratedFlowLph,powerW]):EquipmentProfile=>({id:`jeneca-${model.toLowerCase()}`,category:"filter",brand:"Jeneca",model,specifications:`Mekanik, biyolojik ve kimyasal filtrelemeli iç filtre · ${ratedFlowLph} L/saat · ${String(powerW).replace(".",",")} W`,ratedFlowLph,powerW,sourceUrl:"https://fishyhub.com/product-detail/jeneca-internal-filter-glb600-800-1000-17206",verifiedAt:"2026-08-30"})),
  {id:"jeneca-ipf-060",category:"filter",brand:"Jeneca",model:"IPF-060",specifications:"Oksijenlendirmeli iç filtre · 500 L/saat · güç bilgisi kaynaklarda çelişkili",ratedFlowLph:500,sourceUrl:"https://www.pezeraacuario.com/product/filtro-sumergible-ipf-060/",verifiedAt:"2026-08-30"},
  {id:"jeneca-ipf-080",category:"filter",brand:"Jeneca",model:"IPF-080",specifications:"Çift çıkışlı iç filtre · 800 L/saat · 18 W",ratedFlowLph:800,powerW:18,sourceUrl:"https://aquaplanet.pl/p/77/724/jeneca-filtr-wewnetrzny-ipf-080-800l-h-do-150l-filtry-wewnetrzne-filtracja.html",verifiedAt:"2026-08-30"},
  {id:"jeneca-ipf-180",category:"filter",brand:"Jeneca",model:"IPF-180",specifications:"Çift çıkışlı iki hazneli iç filtre · 1200 L/saat · 25 W",ratedFlowLph:1200,powerW:25,sourceUrl:"https://zwierzomarket.pl/jeneca-filtr-wewnetrzny-ipf-180-1200lh-do-250l-p-34986.html",verifiedAt:"2026-08-30"},
  {id:"jeneca-ipf-280",category:"filter",brand:"Jeneca",model:"IPF-280",specifications:"Üç hazneli iç filtre · 1800 L/saat · 30 W",ratedFlowLph:1800,powerW:30,sourceUrl:"https://www.mercadolibre.com.co/filtro-interno-sumergible-jeneca-ipf-280-1800-lh-30w-bioesponja-acuarios-grandes/p/MCO23696795",verifiedAt:"2026-08-30"},
  {id:"jeneca-ipf-380",category:"filter",brand:"Jeneca",model:"IPF-380",specifications:"Dört hazneli iç filtre · 2500 L/saat · 40 W",ratedFlowLph:2500,powerW:40,sourceUrl:"https://www.mercadolibre.com.co/filtro-interno-jeneca-ipf-380-para-acuarios-2500lh-40w/p/MCO22893727",verifiedAt:"2026-08-30"},
  {id:"jeneca-ipf-228",category:"filter",brand:"Jeneca",model:"IPF-228",specifications:"Yağmurlama borulu kompakt iç filtre · 220 L/saat · 4 W",ratedFlowLph:220,powerW:4,sourceUrl:"https://eastoceansg.com/products/jeneca-ipf-228-internal-filter",verifiedAt:"2026-08-30"},
  {id:"jeneca-ipf-628",category:"filter",brand:"Jeneca",model:"IPF-628",specifications:"Ayarlanabilir yağmurlama borulu iç filtre · 450 L/saat · 7 W",ratedFlowLph:450,powerW:7,adjustableFlow:true,sourceUrl:"https://allegro.pl/produkt/filtr-wewnetrzny-gabkowy-jeneca-jeipf-628-biologiczny-mechaniczny-1327bdbe-d85f-4700-a2cf-5dbb686921b4",verifiedAt:"2026-08-30"},
  {id:"jeneca-ipf-260",category:"filter",brand:"Jeneca",model:"IPF-260",specifications:"Üç aşamalı iç filtre · 400 L/saat · 5 W",ratedFlowLph:400,powerW:5,sourceUrl:"https://spanish.alibaba.com/product-detail/Jeneca-IPF-260-5W-400L-H-1601270178274.html",verifiedAt:"2026-08-30"},
  {id:"jeneca-ipf-360",category:"filter",brand:"Jeneca",model:"IPF-360",specifications:"Üç işlevli iç filtre · 600 L/saat · 8 W",ratedFlowLph:600,powerW:8,sourceUrl:"https://www.skroutz.mt/s/39180148/Jeneca-Internal-Filter-8W-with-Performance-600lt-h.html",verifiedAt:"2026-08-30"},
  {id:"jeneca-ipf-460",category:"filter",brand:"Jeneca",model:"IPF-460",specifications:"Üç işlevli iç filtre · 800 L/saat · 15 W",ratedFlowLph:800,powerW:15,sourceUrl:"https://www.skroutz.de/s/39180151/Jeneca-Intern-Aquarium-Filter-fuer-Aquarien-mit-einer-Leistung-von-800lt-h-und-einer-Leistung-von-15W-IPF-460.html",verifiedAt:"2026-08-30"},
  {id:"jeneca-ipf-480",category:"filter",brand:"Jeneca",model:"IPF-480",specifications:"Üç işlevli iç filtre · 1000 L/saat · 20 W",ratedFlowLph:1000,powerW:20,sourceUrl:"https://www.skroutz.gr/s/39180105/Jeneca-interior-filtar-na-akvarium-s-proizvoditelnost-1000lt-h-i-moshtnost-20W-IPF-480.html",verifiedAt:"2026-08-30"},
  {id:"jeneca-ipf-560",category:"filter",brand:"Jeneca",model:"IPF-560",specifications:"Üç işlevli iç filtre · 1500 L/saat · 25 W",ratedFlowLph:1500,powerW:25,sourceUrl:"https://www.acuarioacuaworld.com/internos/225-filtro-interno-ipf-560.html",verifiedAt:"2026-08-30"},
  {id:"jeneca-xp-01a",category:"filter",brand:"Jeneca",model:"XP-01A",specifications:"Düşük su seviyeli kaplumbağa tankı iç filtresi · 90 L/saat · 2,5 W",ratedFlowLph:90,powerW:2.5,sourceUrl:"https://www.aleas.cn/product/697.html",verifiedAt:"2026-09-04"},
  {id:"jeneca-ym-01",category:"filter",brand:"Jeneca",model:"YM-01",specifications:"Harici bir su pompasına bağlanan pasif yüzey yağ filmi emici · kendi motoru ve bağımsız debisi yok · ana filtrenin yerine geçmez",passiveComponent:true,auxiliaryFiltration:true,capacityDataNote:"YM-01 pompasız bir yüzey emiş aksesuarıdır; bağımsız filtre debisi bulunmaz ve ana filtrasyon kapasitesine eklenmez.",sourceUrl:"https://www.aleas.cn/product/518.html",additionalSourceUrls:["https://www.jd.com/hprm/6728f65ec76d345aa3b4.html?electedExtAttrSet=878%2C&extAttrValue=expand_name%2C%4042888%3A%3A878&sort_type=sort_default"],verifiedAt:"2026-09-04"},
  {id:"jeneca-ym-03",category:"filter",brand:"Jeneca",model:"YM-03",specifications:"Motorlu yüzey skimmeri · 300 L/saat · 5 W · 300 litreye kadar · ana biyolojik filtrenin yerine geçmez",ratedFlowLph:300,powerW:5,recommendedMaxL:300,auxiliaryFiltration:true,sourceUrl:"https://seasunaquarium.com/shop/index.php?category_id=96&flypage=shop.flypage_lite_pdf&option=com_virtuemart&page=shop.product_details&product_id=1680&vmcchk=1",additionalSourceUrls:["https://www.ceneo.pl/179851847"],verifiedAt:"2026-09-04"},
  ...([[
    "GL-3",250,3], ["GL-5",300,3.5], ["GL-7",350,4],
  ] as const).map(([model,ratedFlowLph,powerW]):EquipmentProfile=>({id:`jeneca-${model.toLowerCase()}`,category:"filter",brand:"Jeneca",model,specifications:`Arkadan asılan çok bölmeli iç filtre pompası · ${ratedFlowLph} L/saat · ${String(powerW).replace(".",",")} W`,ratedFlowLph,powerW,sourceUrl:"https://www.aleas.cn/product/485.html",verifiedAt:"2026-09-04"})),
  {id:"jeneca-ipf-338",category:"filter",brand:"Jeneca",model:"IPF-338",specifications:"Yağmurlama borulu iç filtre · 300 L/saat · 5 W · üretici ürün kimliği IPF-338 olmasına rağmen teknik tablo satırında PF-338 ön eki kullanılıyor",ratedFlowLph:300,powerW:5,sourceUrl:"https://www.aleas.cn/product/483.html",additionalSourceUrls:["https://www.oceanoshop.com/filtros-interiores-para-acuarios/2077-filtro-interior-300lh-5w-ipf-338.html","https://www.rsdiscus.com.br/equipamentos/jeneca-filtro-interno-ipf-338-300-l-h-110-v-p"],verifiedAt:"2026-09-04"},
  ...([[
    "GD-400",500,7],["GD-500",500,7],["GD-600",1100,17],
  ] as const).map(([model,ratedFlowLph,powerW]):EquipmentProfile=>({id:`jeneca-${model.toLowerCase()}`,category:"filter",brand:"Jeneca",model,specifications:`Ayarlanabilir çerçeveli üst filtre · ${ratedFlowLph} L/saat · ${powerW} W`,ratedFlowLph,powerW,sourceUrl:"https://eastoceansg.com/products/jeneca-gd-400-overhead-filter",verifiedAt:"2026-08-30"})),
  {id:"jeneca-gd-320",category:"filter",brand:"Jeneca",model:"GD-320",specifications:"Ayarlanabilir çerçeveli üst filtre · teknik kaynaklar güç ve debi konusunda çelişkili",adjustableFlow:true,capacityDataNote:"Jeneca/ALEAS üretici kataloğu ve güncel satış kayıtları 4 W yayımlıyor ancak debi vermiyor; bağımsız ürün sayfası D-320 yazımıyla 459 L/saat ve 6 W yayımlıyor. Model etiketi ve güç çelişkisi çözülene kadar otomatik filtrasyon hesabına katılmaz.",sourceUrl:jenecaOfficialTopFilterSource,additionalSourceUrls:["https://www.jd.com/xinghao/9855d3030e59b0d6a562.html","https://cacung.vn/loc-mang-cho-be-ca-loai-dep-jeneca-gd-320-gd-400-gd-600-nhua-abs-ong-cung-chinh-hang"],verifiedAt:"2026-09-07"},
];
...
const jenecaOfficialExpandedAirPumps:EquipmentProfile[]=[
  {id:"jeneca-ap-601",category:"air_pump",brand:"Jeneca",model:"AP-601",specifications:"Sessiz tek çıkışlı hava motoru · 3 L/dakika (180 L/saat) · 2 W",ratedFlowLph:180,powerW:2,sourceUrl:"https://eastoceansg.com/products/jeneca-ap-601-air-pump",verifiedAt:"2026-08-30"},
  {id:"jeneca-ap-602",category:"air_pump",brand:"Jeneca",model:"AP-602",specifications:"Sessiz çift çıkışlı hava motoru · 2 × 3 L/dakika (360 L/saat toplam) · 4 W",ratedFlowLph:360,powerW:4,sourceUrl:"https://eastoceansg.com/products/jeneca-ap-601-air-pump",verifiedAt:"2026-08-30"},
  {id:"jeneca-ap-8806",category:"air_pump",brand:"Jeneca",model:"AP-8806",specifications:"Ayarlanabilir çift çıkışlı hava motoru · 2 × 4,3 L/dakika (516 L/saat toplam) · 4,1 W · 300–600 litre · 0,022 MPa",ratedFlowLph:516,powerW:4.1,recommendedMinL:300,recommendedMaxL:600,adjustableFlow:true,sourceUrl:"https://zoo-aquos.pl/pl/p/Jeneca-AP-8806-Napowietrzacz-Do-Akwarium-300-600l-2-Wyjsciowy/5689",verifiedAt:"2026-08-30"},
  {id:"jeneca-ap-10000",category:"air_pump",brand:"Jeneca",model:"AP-10000",specifications:"Ayarlanabilir çift çıkışlı hava motoru · 2 × 3,3 L/dakika (396 L/saat toplam) · 3,3 W · 0,013 MPa",ratedFlowLph:396,powerW:3.3,adjustableFlow:true,sourceUrl:"https://www.goldsupplier.com/provide/p124207337.html",verifiedAt:"2026-08-30"},
  {id:"jeneca-ap-12000",category:"air_pump",brand:"Jeneca",model:"AP-12000",specifications:"Ayarlanabilir çift çıkışlı hava motoru · 2 × 3 L/dakika (360 L/saat toplam) · 4 W · 0,016 MPa",ratedFlowLph:360,powerW:4,adjustableFlow:true,sourceUrl:"https://www.goldsupplier.com/provide/p124207337.html",verifiedAt:"2026-08-30"},
  {id:"jeneca-ap-15000",category:"air_pump",brand:"Jeneca",model:"AP-15000",specifications:"Ayarlanabilir hava motoru · 6 L/dakika (360 L/saat) · 6 W · 0,02 MPa",ratedFlowLph:360,powerW:6,adjustableFlow:true,sourceUrl:"https://swallowaquatics.co.uk/products/air-pump-ap-15000",verifiedAt:"2026-08-30"},
  {id:"jeneca-ap-22000",category:"air_pump",brand:"Jeneca",model:"AP-22000",specifications:"Ayarlanabilir çift çıkışlı hava motoru · 2 × 4 L/dakika (480 L/saat toplam) · 0,023 MPa · güç bilgisi kaynaklarda 8 W ve 12 W olarak çelişkili",ratedFlowLph:480,adjustableFlow:true,sourceUrl:"https://swallowaquatics.co.uk/products/air-pump-ap-22000",additionalSourceUrls:["https://www.ninekaow.com/shop/brand/jeneca/8"],verifiedAt:"2026-08-30"},
  {id:"jeneca-ap-30000",category:"air_pump",brand:"Jeneca",model:"AP-30000",specifications:"Ayarlanabilir yüksek çıkışlı hava motoru · 10 L/dakika (600 L/saat) · 10 W · 0,025 MPa",ratedFlowLph:600,powerW:10,adjustableFlow:true,sourceUrl:"https://tecki.vn/p1.43035484.11157006721-may-suc-oxy-be-ca-may-sui-oxy-sieu-em-jeneca-ap-30000-ap-40000-4-voi-co-dieu-chinh-luu-luong-chinh-hang",verifiedAt:"2026-08-30"},
  {id:"jeneca-ap-40000",category:"air_pump",brand:"Jeneca",model:"AP-40000",specifications:"Ayarlanabilir dört çıkışlı hava motoru · 20 L/dakika (1200 L/saat) · 12 W · 0,025 MPa",ratedFlowLph:1200,powerW:12,adjustableFlow:true,sourceUrl:"https://tecki.vn/p1.43035484.11157006721-may-suc-oxy-be-ca-may-sui-oxy-sieu-em-jeneca-ap-30000-ap-40000-4-voi-co-dieu-chinh-luu-luong-chinh-hang",verifiedAt:"2026-08-30"},
  {id:"jeneca-db-58",category:"air_pump",brand:"Jeneca",model:"DB-58",specifications:"Ayarlanabilir yüksek çıkışlı yağsız hava motoru · 55 L/dakika (3300 L/saat) · 25 W · 0,045 MPa",ratedFlowLph:3300,powerW:25,adjustableFlow:true,sourceUrl:"https://www.aleas.cn/product/414.html",additionalSourceUrls:["https://thaiaquariumcenter.tarad.com/products_detail/view/7875835","https://www.acuarioacuaworld.com/aireadores/164-compresor-potente-db-58-55l-.html"],verifiedAt:"2026-08-30"},
  {id:"jeneca-db-21",category:"air_pump",brand:"Jeneca",model:"DB-21",specifications:"Ayarlanabilir düşük sesli hava motoru · 18 L/dakika (1080 L/saat) · 10 W",ratedFlowLph:1080,powerW:10,adjustableFlow:true,sourceUrl:"https://riversideestacion.cl/tienda/db-21-compresor-silenciosa-10w-18-l-minregulador-de-potencia/",verifiedAt:"2026-08-30"},
  {id:"jeneca-db-31",category:"air_pump",brand:"Jeneca",model:"DB-31",specifications:"Düşük sesli hava motoru · 30 L/dakika (1800 L/saat) · 16 W · ≥0,030 MPa",ratedFlowLph:1800,powerW:16,sourceUrl:"https://seasunaquarium.com/shop/index2.php?only_page=1&option=com_virtuemart&page=shop.product_details&pop=1&product_id=440&tmpl=component",additionalSourceUrls:["https://thaiaquariumcenter.tarad.com/products_detail/view/7931639"],verifiedAt:"2026-08-30"},
  {id:"jeneca-db-51",category:"air_pump",brand:"Jeneca",model:"DB-51",specifications:"Sekiz çıkışlı profesyonel hava motoru · 51 L/dakika (3060 L/saat) · 25 W",ratedFlowLph:3060,powerW:25,sourceUrl:"https://www.fullacuarios.cl/producto/compresor-profesional-51-lt-min-12641",additionalSourceUrls:["https://www.mercadolibre.cl/compresor-aire-profesional-acuario-jeneca-51-lmin/up/MLCU3910917279"],verifiedAt:"2026-08-30"},
  {id:"jeneca-db-81",category:"air_pump",brand:"Jeneca",model:"DB-81",specifications:"On iki çıkışlı profesyonel hava motoru · 80 L/dakika (4800 L/saat) · 42 W",ratedFlowLph:4800,powerW:42,sourceUrl:"https://www.fullacuarios.cl/producto/compresor-profesional-80-l-min-12639",verifiedAt:"2026-08-30"},
  {id:"jeneca-ap-06",category:"air_pump",brand:"Jeneca",model:"AP-06",specifications:"Ayarlanabilir çift çıkışlı hava motoru · 2 × 7 L/dakika (840 L/saat toplam) · 7 W · 0,02 MPa",ratedFlowLph:840,powerW:7,adjustableFlow:true,sourceUrl:"https://www.aleas.cn/product/412.html",verifiedAt:"2026-09-04"},
  {id:"jeneca-ap-20000",category:"air_pump",brand:"Jeneca",model:"AP-20000",specifications:"Ayarlanabilir yüksek çıkışlı hava motoru · 8 L/dakika (480 L/saat) · 8 W · 0,023 MPa",ratedFlowLph:480,powerW:8,adjustableFlow:true,sourceUrl:"https://www.aleas.cn/product/411.html",verifiedAt:"2026-09-04"},
  {id:"jeneca-ap-18000",category:"air_pump",brand:"Jeneca",model:"AP-18000",specifications:"Hava motoru · 8 L/dakika (480 L/saat) · 6 W · 0,018 MPa · 180 × 135 × 95 mm",ratedFlowLph:480,powerW:6,sourceUrl:"https://www.aleas.cn/product/445.html",verifiedAt:"2026-09-04"},
  {id:"jeneca-db-11",category:"air_pump",brand:"Jeneca",model:"DB-11",specifications:"Düşük sesli hava motoru · 11 L/dakika (660 L/saat) · 6,5 W · ≥0,020 MPa",ratedFlowLph:660,powerW:6.5,sourceUrl:"https://www.aleas.cn/product/701.html",verifiedAt:"2026-09-04"},
  {id:"jeneca-db-58-upgrade",category:"air_pump",brand:"Jeneca",model:"DB-58 Upgrade",specifications:"Ayarlanabilir yüksek çıkışlı hava motoru · en fazla 55 L/dakika (3300 L/saat) · en fazla 25 W",ratedFlowLph:3300,powerW:25,adjustableFlow:true,sourceUrl:"https://www.aleas.cn/product/642.html",additionalSourceUrls:["https://siam-post.com/shopping/product/91159-jeneca-db-31-db-58-db-58upgrade-jeneca-air-pump-diapham-pump-db-58-upgrade-db58-"],verifiedAt:"2026-09-04"},
  {id:"jeneca-db-11-upgrade",category:"air_pump",brand:"Jeneca",model:"DB-11 Upgrade",specifications:"Ayarlanabilir düşük sesli hava motoru · 11 L/dakika (660 L/saat) · 6,5 W · ≥0,020 MPa",ratedFlowLph:660,powerW:6.5,adjustableFlow:true,sourceUrl:"https://gb.aleas.cn/product/644.html",verifiedAt:"2026-09-04"},
  {id:"jeneca-db-21-upgrade",category:"air_pump",brand:"Jeneca",model:"DB-21 Upgrade",specifications:"Ayarlanabilir düşük sesli hava motoru · 18 L/dakika (1080 L/saat) · 10 W · ≥0,025 MPa",ratedFlowLph:1080,powerW:10,adjustableFlow:true,sourceUrl:"https://gb.aleas.cn/product/644.html",verifiedAt:"2026-09-04"},
];
...
const jenecaOfficialExpandedHeaters:EquipmentProfile[]=[
  ...
  ...["SX-366","SX-388"].flatMap(model=>[1000,1200,1500].map((powerW):EquipmentProfile=>({id:`jeneca-${model.toLowerCase()}-${powerW}w`,category:"heater",brand:"Jeneca",model:`${model} ${powerW} W`,specifications:`Harici dijital kontrol kutulu titanyum ısıtıcı · ${powerW} W · tatlı ve tuzlu su uyumlu · üretici hacim aralığı yayımlamamış`,powerW,sourceUrl:"https://www.aleas.cn/product/641.html",verifiedAt:"2026-08-30"}))),
  {id:"jeneca-sx-265-500w",category:"heater",brand:"Jeneca",model:"SX-265 500 W",specifications:"Dijital kontrollü metal akvaryum ısıtıcısı · 500 W · 500 litreye kadar",powerW:500,recommendedMaxL:500,sourceUrl:"https://www.blibli.com/p/jeneca-sx265-500w-500-w-heater-digital-pemanas-air-aquarium/ps--NEG-70031-01289",verifiedAt:"2026-08-30"},
  ...([25,50,100,200,300] as const).map((powerW):EquipmentProfile=>({id:`jeneca-al-22-${powerW}w`,category:"heater",brand:"Jeneca",model:`AL-22 ${powerW} W`,specifications:`Ayarlanabilir cam termostatlı akvaryum ısıtıcısı · ${powerW} W · 22–34 °C`,powerW,sourceUrl:"https://produto.mercadolivre.com.br/MLB-1804153236-termostato-aquecedor-aleas-100w-para-aquario-_JM",verifiedAt:"2026-08-30"})),
  ...([50,100,300,500] as const).map((powerW):EquipmentProfile=>({id:`jeneca-al-28-${powerW}w`,category:"heater",brand:"Jeneca",model:`AL-28 ${powerW} W`,specifications:`Cam termostatlı akvaryum ısıtıcısı · ${powerW} W · satıcı hacim aralığı yayımlamamış`,powerW,sourceUrl:"https://shopee.co.th/Jeneca-Aquarium-Heater-50w-100w-300w-%E0%B9%80%E0%B8%84%E0%B8%A3%E0%B8%B7%E0%B9%88%E0%B8%AD%E0%B8%87%E0%B8%97%E0%B8%B3%E0%B8%84%E0%B8%A7%E0%B8%B2%E0%B8%A1%E0%B8%A3%E0%B9%89%E0%B8%AD%E0%B8%99%E0%B8%95%E0%B8%B9%E0%B9%89%E0%B8%9B%E0%B8%A5%E0%B8%B2-%E0%B9%81%E0%B8%97%E0%B9%88%E0%B8%87%E0%B8%84%E0%B8%A7%E0%B8%B2%E0%B8%A1%E0%B8%A3%E0%B9%89%E0%B8%AD%E0%B8%99-AL-3201-AL-28-Glass-Heating-Rod-i.173519701.13957679715",verifiedAt:"2026-08-30"})),
  ...([
    [25,5,40],[50,30,60],[100,50,120],[200,150,250],[300,250,350],[500,undefined,500],
  ] as const).map(([powerW,recommendedMinL,recommendedMaxL]):EquipmentProfile=>({id:`jeneca-bx-22-${powerW}w`,category:"heater",brand:"Jeneca",model:`BX-22 ${powerW} W`,specifications:`Darbeye dayanıklı metal termostatlı ısıtıcı · ${powerW} W · ${recommendedMinL===undefined?`500 litreye kadar`:`${recommendedMinL}–${recommendedMaxL} litre`}`,powerW,recommendedMinL,recommendedMaxL,sourceUrl:"https://aquaplanet.pl/c/69/ogrzewanie-i-chlodzenie.html",verifiedAt:"2026-08-30"})),
  {id:"jeneca-bx-28-500w",category:"heater",brand:"Jeneca",model:"BX-28 500 W",specifications:"Darbeye dayanıklı paslanmaz çelik termostatlı ısıtıcı · 500 W · 500 litreye kadar · 20–34 °C",powerW:500,recommendedMaxL:500,sourceUrl:"https://aquaplanet.pl/p/80/1761/jeneca-grzalka-metalowa-bx-28-500w-nietlukaca-grzalki-ogrzewanie-i-chlodzenie.html",verifiedAt:"2026-08-30"},
  ...([200,300,500] as const).map((powerW):EquipmentProfile=>({id:`jeneca-bx-29-${powerW}w`,category:"heater",brand:"Jeneca",model:`BX-29 ${powerW} W`,specifications:`Koruyucu kapaklı titanyum çekirdekli dijital ısıtıcı · ${powerW} W · ${powerW} litreye kadar`,powerW,recommendedMaxL:powerW,sourceUrl:"https://www.luby-china.com/Aquatics_detail?product_id=2011",verifiedAt:"2026-08-30"})),
];
...
const eurostarFilters: EquipmentProfile[] = [
  ...
  { id:"eurostar-motorized-sponge-medium", category:"filter", brand:"Eurostar", model:"Motorlu Pipo Filtre Medium", specifications:"Kendinden motorlu, filtre medyası hazneli sünger filtre · 5 W · ürün kodu 452-SG-YU228C-1 · barkod 1452000189084 · 17,5 × 23 cm · 5 × 12 cm sünger", powerW:5, capacityDataNote:"Yetkili satıcı ürün sayfasında su debisi veya önerilen hacim yayımlanmamış; benzer modelden tahmin edilmedi.", sourceUrl:"https://atakanpetshop.com/eurostar-motorlu-pipo-filtre---filtre-malzemeli-medium-5w", verifiedAt:"2026-09-06" },
  { id:"eurostar-motorized-sponge-large", category:"filter", brand:"Eurostar", model:"Motorlu Pipo Filtre Large", specifications:"Kendinden motorlu, filtre medyası hazneli sünger filtre · 5 W · ürün kodu 452-SG-YU229C-1 · barkod 1452000189077 · 18,5 × 25 cm · 6 × 13 cm sünger", powerW:5, capacityDataNote:"Yetkili satıcı ürün sayfasında su debisi veya önerilen hacim yayımlanmamış; benzer modelden tahmin edilmedi.", sourceUrl:"https://atakanpetshop.com/eurostar-motorlu-pipo-filtre---filtre-malzemeli-large-5w", verifiedAt:"2026-09-06" },
  ...
  { id:"eurostar-glass-thermometer-yellow-thin", category:"other", brand:"Eurostar", model:"Cam Derece Sarı İnce", specifications:"İnce cam akvaryum termometresi · ürün kodu 452-1600 · barkod 8681144116004", sourceUrl:"https://atakanpetshop.com/eurostar-cam-derece-sari-ince-452-1600", verifiedAt:"2026-09-09" },
  { id:"eurostar-glass-thermometer-yellow-6", category:"other", brand:"Eurostar", model:"Sarı Cam Derece 6 cm", specifications:"Kompakt cam akvaryum termometresi · 6 cm · ürün kodu 452-YD-H060 · barkod 6500252930604", sourceUrl:"https://atakanpetshop.com/eurostar-sari-cam-derece-6cm-452-yd-h060", verifiedAt:"2026-09-09" },
  { id:"eurostar-hose-cleaning-brush-48", category:"other", brand:"Eurostar", model:"Hortum İçi Temizleme Harbisi 48 cm", specifications:"Akvaryum hortumlarının iç yüzeyini temizlemek için esnek harbi · 48 cm · ürün kodu 452-SG-SDTB48CM · barkod 8681144116110", sourceUrl:"https://atakanpetshop.com/eurostar-hortum-ici-temizleme-harbisi-48cm", verifiedAt:"2026-09-09" },
  { id:"eurostar-mangrove-decor-m", category:"other", brand:"Eurostar", model:"Mangrove Akvaryum Dekoru M", specifications:"Doğal Mangrove kökü akvaryum dekoru · 20–30 cm · ürün kodu 990-K0000M · barkod 1990000229701", sourceUrl:"https://atakanpetshop.com/eurostar-mangrove-akvaryum-dekoru-m-20-30-cm-990-k0000m", verifiedAt:"2026-09-09" },
  { id:"eurostar-mangrove-decor-l", category:"other", brand:"Eurostar", model:"Mangrove Akvaryum Dekoru L", specifications:"Doğal Mangrove kökü akvaryum dekoru · 30–40 cm · ürün kodu 990-K0000L · barkod 1990000229909", sourceUrl:"https://atakanpetshop.com/eurostar-mangrove-akvaryum-dekoru-l-30-40-cm-990-k0000l", verifiedAt:"2026-09-09" },
...
const haqosEquipment:EquipmentProfile[]=[
  ...
  {id:"haqos-easy-1000at",category:"filter",brand:"Haqos",model:"EASY-1000AT",specifications:"Üreticinin resmî ürün kataloğundaki filtrasyon sistemi · doğrulanabilir debi ve güç bilgisi yok",capacityDataNote:"Üreticinin model sayfasında debi ve güç metin olarak yayımlanmamış; teknik içerik harici bir görselde tutuluyor ancak görsel sunucusuna erişilemedi. Güvenilir satıcı kaynağı da bulunamadığı için değer tahmin edilmez ve otomatik kapasite hesabına katılmaz.",sourceUrl:"https://www.haqos.com/productshow-45495781.html",verifiedAt:"2026-09-08"},
  {id:"haqos-aqua-flow-250",category:"filter",brand:"Haqos",model:"Aqua Flow 250",specifications:"Üreticinin resmî ürün kataloğundaki akvaryum filtresi · doğrulanabilir debi ve güç bilgisi yok",capacityDataNote:"Üreticinin model sayfasında debi ve güç metin olarak yayımlanmamış; teknik içerik harici bir görselde tutuluyor ancak görsel sunucusuna erişilemedi. Güvenilir satıcı kaynağı bulunamadı, aynı adlı başka marka ürünlerin değerleri kullanılmadı ve otomatik kapasite hesabına katılmaz.",sourceUrl:"https://www.haqos.com/productshow-45495780.html",verifiedAt:"2026-09-08"},
  ...
  {id:"haqos-thermo-sprite",category:"heater",brand:"Haqos",model:"Thermo-Sprite Micro Plastic Heater",specifications:"Kırılmaz plastik gövdeli, kompakt ve sabit sıcaklıklı akvaryum ısıtıcısı · 15 W · 14 × 2,5 cm",powerW:15,sourceUrl:"https://www.haqos.com/productshow-45495753.html",additionalSourceUrls:["https://www.bettamarketim.com.tr/haqos-mikro-rezistans-kaplumbaga-isiticisi-15-watt"],verifiedAt:"2026-09-06"},
];
...
const jingyeEquipment:EquipmentProfile[]=[
  ...
  {id:"jingye-w155",category:"filter",brand:"Jingye",model:"JY-W155",specifications:"Şeffaf askı filtre · 250 L/saat · 3,8 W · 60 litreye kadar · barkod 6972934053114",ratedFlowLph:250,powerW:3.8,recommendedMaxL:60,adjustableFlow:true,sourceUrl:"https://atakanpetshop.com/jingye-seffaf-aski-filtre-beyaz-38w-250lh",verifiedAt:"2026-09-09"},
  {id:"jingye-w255",category:"filter",brand:"Jingye",model:"JY-W255",specifications:"Şeffaf askı filtre · 400 L/saat · 3,8 W · 80 litreye kadar · barkod 6972934053121",ratedFlowLph:400,powerW:3.8,recommendedMaxL:80,adjustableFlow:true,sourceUrl:"https://atakanpetshop.com/jingye-w255-seffaf-aski-filtre-38w-400ls",verifiedAt:"2026-09-09"},
  {id:"jingye-w355",category:"filter",brand:"Jingye",model:"JY-W355",specifications:"Şeffaf askı filtre · 500 L/saat · 3,8 W · 100 litreye kadar · barkod 6972934053138",ratedFlowLph:500,powerW:3.8,recommendedMaxL:100,adjustableFlow:true,sourceUrl:"https://atakanpetshop.com/jingye-w355-seffaf-aski-filtre-38w-500ls",verifiedAt:"2026-09-09"},
  {id:"jingye-6100f",category:"filter",brand:"Jingye",model:"JY-6100F",specifications:"Şeffaf iç filtre · 500 L/saat · 6 W · 80 litreye kadar · barkod 6972934052643",ratedFlowLph:500,powerW:6,recommendedMaxL:80,sourceUrl:"https://atakanpetshop.com/jingye-6100f-seffaf-ic-filtre-beyaz-6w-500ls",verifiedAt:"2026-09-09"},
  {id:"jingye-black-transparent-6972934051028",category:"filter",brand:"Jingye",model:"6972934051028 Şeffaf İç Filtre Siyah",specifications:"Model kodu yayımlanmayan siyah şeffaf iç filtre · 500 L/saat · 6 W · 80 litreye kadar · ürün kodu ve barkod 6972934051028",ratedFlowLph:500,powerW:6,recommendedMaxL:80,sourceUrl:"https://atakanpetshop.com/jingye-seffaf-ic-filtre-siyah-6w-500l-h",verifiedAt:"2026-09-09"},
  {id:"jingye-6600f",category:"filter",brand:"Jingye",model:"JY-6600F",specifications:"Şeffaf iç filtre · 1500 L/saat · 35 W · 250–300 litre · barkod 6972934052698",ratedFlowLph:1500,powerW:35,recommendedMinL:250,recommendedMaxL:300,sourceUrl:"https://atakanpetshop.com/jingye-seffaf-ic-filtre-beyaz-35w-1500lh",verifiedAt:"2026-09-09"},
  {id:"jingye-801f",category:"filter",brand:"Jingye",model:"JY-801F",specifications:"Silindir iç filtre · 880 L/saat · 15 W · 100–200 litre · barkod 6972934050144",ratedFlowLph:880,powerW:15,recommendedMinL:100,recommendedMaxL:200,sourceUrl:"https://atakanpetshop.com/jingye-801f-silindir-ic-filtre-siyah-15w-880lh-jy-801f",verifiedAt:"2026-09-09"},
  ...
  {id:"jingye-lv1000dx",category:"other",brand:"Jingye",model:"LV-1000DX",specifications:"Sump motoru · 750 L/saat · 10 W · 0,9 m basma yüksekliği · 150 litreye kadar · barkod 6972934052889",ratedFlowLph:750,powerW:10,recommendedMaxL:150,sourceUrl:"https://atakanpetshop.com/jingye-sump-motoru-10w-750lh",verifiedAt:"2026-09-09"},
  {id:"jingye-lv2000dx",category:"other",brand:"Jingye",model:"LV-2000DX",specifications:"Sump motoru · 1500 L/saat · 25 W · 1,8 m basma yüksekliği · 300 litreye kadar · barkod 6972934051370",ratedFlowLph:1500,powerW:25,recommendedMaxL:300,sourceUrl:"https://atakanpetshop.com/jingye-sump-motoru-25w-1500lh-lv-2000dx",verifiedAt:"2026-09-09"},
  {id:"jingye-lv2500dx",category:"other",brand:"Jingye",model:"LV-2500DX",specifications:"Sump motoru · 2500 L/saat · 35 W · 2,4 m basma yüksekliği · 500 litreye kadar · barkod 6972934051387",ratedFlowLph:2500,powerW:35,recommendedMaxL:500,sourceUrl:"https://atakanpetshop.com/jingye-sump-motoru-35w-2500lh-lv-2500dx",verifiedAt:"2026-09-09"},
  {id:"jingye-jy104",category:"other",brand:"Jingye",model:"JY-104",specifications:"Sump motoru · 3000 L/saat · 40 W · 2,5 m basma yüksekliği · 500 litreye kadar",ratedFlowLph:3000,powerW:40,recommendedMaxL:500,sourceUrl:"https://atakanpetshop.com/jingye-104-sump-motoru-siyah-40w-3000ls-jy-104",verifiedAt},
  ...
  {id:"jingye-jy920",category:"other",brand:"Jingye",model:"JY-920",specifications:"Üst filtre haznesine su basan dalgıç pompa · 1200 L/saat · 18 W · 1,2 m basma yüksekliği · 100–200 litre · barkod 6972934050502",ratedFlowLph:1200,powerW:18,recommendedMinL:100,recommendedMaxL:200,sourceUrl:"https://atakanpetshop.com/jingye-dalgic-filtre-pompasi-beyaz-18w-1200lh-jy-920",verifiedAt:"2026-09-09"},
  ...
  {id:"jingye-cd400",category:"air_pump",brand:"Jingye",model:"CD400",specifications:"Şarjlı çift çıkışlı hava motoru · her çıkış 2 L/dakika · toplam 4 L/dakika · 3,5 W · barkod 6972934052735",ratedFlowLph:240,powerW:3.5,sourceUrl:"https://atakanpetshop.com/jingye-cift-cikisli-sarjli-hava-motoru-beyaz-35w-ye-cd400",verifiedAt:"2026-09-09"},
  {id:"jingye-yecc1",category:"other",brand:"Jingye",model:"YE-CC1",specifications:"Yüzer mıknatıslı cam sileceği · kazıyıcı aparat · 6 mm cama kadar · barkod 6972934050984",sourceUrl:"https://atakanpetshop.com/jingye-miknatisli-cam-silecegi-kaziyici-aparatli-ye-cc1",verifiedAt:"2026-09-09"},
  {id:"jingye-cleaning-kit-5in1",category:"other",brand:"Jingye",model:"JY-5X Akvaryum Temizleme Seti 5'li",specifications:"Değiştirilebilir uçlu beş işlevli akvaryum bakım ve temizlik seti · 48 cm · barkod 6972934052605",sourceUrl:"https://atakanpetshop.com/jingye-akvaryum-temizleme-seti-5li-jy-5x",verifiedAt:"2026-09-09"},
];
...
const accessoryEquipment:EquipmentProfile[]=[
  ...
  {id:"nubios-kdsm01-mini",category:"other",brand:"Nubios",model:"KDSM01 Mini",specifications:"Mıknatıslı nano akvaryum cam sileceği · 3 × 3 cm · 2–6 mm cam · ürün kodu 771-KDSM01 · barkod 2900000990104",sourceUrl:"https://atakanpetshop.com/nubios-miknatisli-akvaryum-cam-silecegi-mini-771-kdsm01",verifiedAt:"2026-09-09"},
  {id:"nubios-kdsm02-small",category:"other",brand:"Nubios",model:"KDSM02 Small",specifications:"Mıknatıslı küçük akvaryum cam sileceği · ürün kodu 771-KDSM02 · barkod 2900000990111",sourceUrl:"https://atakanpetshop.com/nubios-miknatisli-akvaryum-cam-silecegi-small-771-kdsm02",verifiedAt:"2026-09-09"},
  ...
  {id:"nubios-fpd51a",category:"other",brand:"Nubios",model:"FPD-51A 5in1",specifications:"58 cm beş fonksiyonlu akvaryum temizlik seti · ürün kodu 771-FPD51A · barkod 6500322990514",sourceUrl:"https://atakanpetshop.com/nubios-5in1-akvaryum-cam-temizleme-ve-bakim-kiti-58cm-771-fpd51a",verifiedAt:"2026-09-09"},
  ...
  {id:"nubios-fpd51t",category:"other",brand:"Nubios",model:"FPD51-T 5in1 Teleskopik",specifications:"Uzatılabilir saplı beş işlevli akvaryum bakım seti · yosun kazıyıcı, balık ağı, bitki maşası, kum düzleştirici ve sünger · ürün kodu 670-FPD51-T · barkod 6500249152514",sourceUrl:"https://atakanpetshop.com/nubios-5in1-teleskopik-akvaryum-cam-temizleme-ve-bakim-kiti",verifiedAt:"2026-09-09"},
  {id:"nubios-nb002-siphon",category:"other",brand:"Nubios",model:"NB-002 Pompalı Dip Sifonu",specifications:"Elle pompalı akvaryum dip temizleme ve su değişim sifonu · ürün kodu 771-S0002 · barkod 6500322990026",sourceUrl:"https://atakanpetshop.com/nubios-nb-002-pompali-dip-sifonu-771-s0002",verifiedAt:"2026-09-09"},
  ...
  {id:"nubios-yu118c",category:"filter",brand:"Nubios",model:"YU-118C",specifications:"Kendi motorlu, ince gözenekli tekli sünger/pipo üretim filtresi · ürün kodu 771-YU118C1 · yavru akvaryumları için emniyetli emiş · vantuzlu · debi yayımlanmamış",capacityDataNote:"Güvenilir satıcı kaynaklarında debi yayımlanmamış; başka marka XY-2900 verisi kopyalanmadı ve kayıt otomatik filtrasyon hesabına katılmaz.",sourceUrl:"https://www.ozelyem.com/nubios-yu-118c-tekli-motorlu-sunger-pipo-filitre",verifiedAt:"2026-09-06"},
  {id:"nubios-yu119c",category:"filter",brand:"Nubios",model:"YU-119C",specifications:"Kendi motorlu, ince gözenekli tekli sünger/pipo üretim filtresi · ürün kodu 771-YU119C · yavru akvaryumları için emniyetli emiş · vantuzlu · 11 × 27 cm · debi yayımlanmamış",capacityDataNote:"Güvenilir satıcı kaynaklarında debi yayımlanmamış; otomatik filtrasyon hesabına katılmaz.",sourceUrl:"https://atakanpetshop.com/nubios-filtre-malzemeli-motorlu-pipo-filtre-small-771-yu119c",verifiedAt:"2026-09-06"},
  ...
  {id:"nubios-turtle-garden-white-46",category:"other",brand:"Nubios",model:"ZHDG-02-B Kaplumbağa Bahçesi Beyaz 46 cm",specifications:"Filtreleme sistemi ve ısıtma lambasıyla sunulan plastik su kaplumbağası yaşam alanı · 46 × 23 × 24 cm · ürün kodu 670-ZHDG-02-B · barkod 1670000197742 · filtre ve lamba güçleri yayımlanmamış",sourceUrl:"https://atakanpetshop.com/nubios-plastik-kaplumbaga-bahcesi-filtreli-isitma-lambali-beyaz-46x23x24-cm",verifiedAt:"2026-09-09"},
  {id:"nubios-turtle-garden-white-66",category:"other",brand:"Nubios",model:"ZHDG-03-B Kaplumbağa Bahçesi Beyaz 66 cm",specifications:"Filtreleme sistemi ve ısıtma lambasıyla sunulan plastik su kaplumbağası yaşam alanı · 66 × 33 × 28 cm · ürün kodu 670-ZHDG-03-B · barkod 1670000197766 · filtre ve lamba güçleri yayımlanmamış",sourceUrl:"https://atakanpetshop.com/nubios-plastik-kaplumbaga-bahcesi-filtreli-isitma-lambali-beyaz-66x33x28-cm",verifiedAt:"2026-09-09"},
  {id:"nubios-turtle-garden-green-46",category:"other",brand:"Nubios",model:"ZHDG-02-Y Kaplumbağa Bahçesi Yeşil 46 cm",specifications:"Filtreleme sistemi ve ısıtma lambasıyla sunulan plastik su kaplumbağası yaşam alanı · 46 × 23 × 24 cm · ürün kodu 670-ZHDG-02-Y · barkod 1670000197759 · filtre ve lamba güçleri yayımlanmamış",sourceUrl:"https://atakanpetshop.com/nubios-plastik-kaplumbaga-bahcesi-filtreli-isitma-lambali-yesil-46x23x24-cm",verifiedAt:"2026-09-09"},
