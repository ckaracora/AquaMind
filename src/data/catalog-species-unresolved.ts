...
const cikletistTetraMainUnresolved: UnresolvedSpeciesListing[] = [
  ...
  unresolvedRetailFish("BIÇAK BALIKLARI", ["Bıçak Balığı", "Knifefish"], "monster", ["freshwater"], "https://www.cikletistpetshop.com/bicak-baliklari", "Bıçak balığı ortak adı erişkin boyu birkaç santimetreden bir metreye yaklaşan farklı familya ve türleri kapsıyor.", ["https://www.fishbase.se/ComNames/CommonNameSearchList.php?CommonName=Knifefish&crit1_operator=CONTAINS&resultPage=1&sortby=nametype&sp=y"]),
  ...
  unresolvedRetailFish("PUFFER BALIKLARI", ["Puffer", "Puffer Balığı", "Balon Balığı"], "puffer", ["freshwater", "brackish", "saltwater"], "https://www.cikletistpetshop.com/puffer-baliklari", "Puffer ve balon balığı adları tatlı, acı ve deniz suyunda yaşayan; boy ve saldırganlığı çok farklı türleri kapsıyor.", ["https://www.fishbase.se/ComNames/CommonNameSearchList.php?CommonName=Puffer&crit1_operator=CONTAINS&resultPage=1&sortby=nametype&sp=y"]),
  {
    ...
    reason: "Alligator Gar ortak adı güvenilir kaynaklarda Atractosteus spatula için kullanılır; ancak satış sayfası bilimsel kimlik yayımlamıyor ve ticarette gar melezleri de bulunuyor. Uzman bakım kaynağı türün 305 cm'ye ulaşabildiğini, ev akvaryumuna uygun olmadığını ve yalnız çok büyük kamusal tesislerde düşünülmesi gerektiğini belirtirken sayısal bir akvaryum tabanı yayımlamıyor. Bu nedenle örnek kimliği ve yetişkin tesisi doğrulanmadan güvenli hacim profili üretilemez.",
    sourceUrl: "https://www.cikletistpetshop.com/alligator-gar-timsah-baliklari",
    additionalSourceUrls: ["https://www.fishbase.se/summary/Atractosteus-spatula.html", "https://www.seriouslyfish.com/species/atractosteus-spatula", "https://www.floridamuseum.ufl.edu/discover-fish/species-profiles/alligator-gar/"],
  ...
  unresolvedRetailFish("İTHAL SARI İMPARATOR CİKLET", ["Sarı İmparator Ciklet", "Yellow Emperor Cichlid"], "cichlid", ["freshwater"], "https://www.cikletistpetshop.com/ithal-sari-imparator-ciklet", "Sarı İmparator ticari adı birden fazla Aulonocara türü ve seçilim hattı için kullanılabiliyor.", ["https://www.fishbase.se/identification/specieslist.php?famcode=349"]),
...
export const unresolvedSpeciesListings: UnresolvedSpeciesListing[] = [
  ...
  },
  {
    ...
    reason: "Satış sayfası bilimsel ad vermiyor. Borneo sucker ve Butterfly loach adları birden fazla tepe-akarsu loach türü için kullanıldığı için fotoğraf veya bilimsel etiket olmadan güvenli eşleme yapılamaz.",
    sourceUrl: "https://www.cikletistpetshop.com/borneo-kelebek-vatoz-1872",
    additionalSourceUrls: ["https://www.loaches.com/articles/Hillstream%20Flyer.pdf", "https://www.tfhmagazine.com/articles/freshwater/in-search-of-borneo-suckers"], verifiedAt: "2026-09-01",
  },
  {
