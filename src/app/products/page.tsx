...
export default function ProductsPage(){
  ...
  return <AppShell><PageHeader title="Ürün Kataloğu"/><div className="mx-auto max-w-[1200px] px-5 py-8 sm:px-8 lg:px-10 lg:py-10">
    <div className="mb-7"><p className="eyebrow mb-2 text-aqua">Akvaryum ürünleri</p><h1 className="text-2xl font-extrabold sm:text-3xl">Ürün Kataloğu</h1><p className="mt-2 text-sm text-[#71858d]">Akvaryum seti, boş tank, yem, dekorasyon ve bakım ürünlerini doğru kategoride bul.</p></div>
